...
class Player():
    ...
    def hit(self):
        ...
        text = font1.render("-5", 1, GREEN)
        screen.blit(text, (screenWidth // 2 - 1, 150))
...
man = Player(600, 360, 64, 64)
enemy = Enemy(100, 360, 64, 64, 500)

font = pygame.font.SysFont("comicsans", 29, True)
